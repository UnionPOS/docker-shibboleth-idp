...
1. `git clone https://github.com/UnionPOS/docker-shibboleth-idp` to pull down the repository
...
Please use the [issue tracker](https://github.com/UnionPOS/docker-shibboleth-idp/issues) to report any bugs or file feature requests.
